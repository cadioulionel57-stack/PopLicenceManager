...
SCHEMA["mouvements_stock"] = [
    ...
    ("reference", "TEXT"),
    # Prix d'achat unitaire HT au moment de l'entrée.
    # Vide sur les sorties. C'est lui qui permet de
    # recalculer la moyenne pondérée du stock.
    ("prix_unitaire_ht", "REAL"),
    ("commentaire", "TEXT")

]
SCHEMA["bundles_composants"] = [

    ("id", "INTEGER PRIMARY KEY AUTOINCREMENT"),

    # Le bundle lui-meme (un produit de type "bundle").
    ("bundle_id", "INTEGER"),

    # Le produit unitaire qui le compose.
    ("produit_id", "INTEGER"),

    # Combien d'exemplaires de ce composant dans un bundle.
