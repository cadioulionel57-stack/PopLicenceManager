...
copie = r"C:\SauvegardeBase\poplicence_avant_carac3_%s.db" % datetime.datetime.now().strftime("%Y%m%d_%H%M")
...
motif = re.compile(
    r"\s*<!--[^>]*CARACT[^>]*-->\s*<section[^>]*>.*?Caract[e\u00e9]ristiques principales.*?</ul>\s*</section>",
